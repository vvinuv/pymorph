...
class CosmoCal:
    ...
    # do integral over a = 1 / (1+z) from az to 1 in n steps, midpoint rule
        ...
        DCMR = (1. - az) * DCMR / n
        age = DTT + zage
        age_Gyr = age * (Tyr / self.H0)
        DTT_Gyr = (Tyr / self.H0) * DTT
        DCMR_Gyr = (Tyr / self.H0) * DCMR
        DCMR_Mpc = (c / self.H0) * DCMR
    ...
    # tangential comoving distance
        ...
        DA_Gyr = (Tyr / self.H0) * DA
        DL = DA / (az * az)
        DL_Mpc = (c / self.H0) * DL
        DL_Gyr = (Tyr / self.H0) * DL
    ...
    # comoving volume computation
        ...
        V_Gpc = 4. * pi * ((0.001 * c / self.H0)**3) * VCM
    #    print '%1.2f' % zage_Gyr,
    #    print '%1.2f' % DCMR_Mpc,
    #    print '%1.2f' % kpc_DA,
