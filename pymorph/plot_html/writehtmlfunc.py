...
class WriteHtmlFunc:
    ...
    def __init__(self, gimg_file, fstring, xcntr, ycntr, alpha_j, delta_j, 
                 distance, z, C, C_err, A, A_err, S, S_err, G, M, 
                 Goodness, EXPTIME):

        self.gimg_file = gimg_file
    ...
    def WriteParams(self):
        ...
        if self.decompose:
            ...
            if(z != 9999 and z > 0):
                phy_parms = cal(z, self.H0, self.WM, self.WV, self.pixelscale)
