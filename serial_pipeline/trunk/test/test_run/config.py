...
sex_cata = 'test_sex.cat'           #The sextractor catalogue which has 
                                      #the format given in the file
clus_cata = 'test_input.cat'         #catalogue of galaxies from
                                      #online catalogu service
                                      #(name ra1 ra2 ra2 dec1 dec2 dec3)

datadir = '/home/vinu/vinucodes/serial_pipeline/trunk/test/' 
				       #the directory containing input images
                                       #if commented out, then program uses
                                       # current directory

###----Specify the output names of images and catalogues----###
out_cata = 'test_out.cat'      #catalogue of galaxies in the field
rootname = 'test'

outdir = '/home/vinu/vinucodes/serial_pipeline/trunk/test/test_run/output/'  
...
size = [1, 1, 2, 1, 120]              #size of the stamp image
