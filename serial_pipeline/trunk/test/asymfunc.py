...
class asymmetry:
    ...
    def __init__(self, cutimage, maskimage, ini_xcntr, ini_ycntr, pa, eg, r50, extraction_radius, background, angle, flag_image, ABS_ZSUM):
        ...
        self.ext_rad            = extraction_radius
        self.pa			= pa
        self.eg			= eg
        self.r50                = r50
...
# image asymmetry 
asymmetry('n5585_lR.fits','BMask.fits', 192.03,157.42,90.0,0.5, 50, 200.0, 1390.377,180.0, 1, 1000000)
# back asymmetry
asymmetry('n5585_lR.fits','BMask.fits', 47,45., 90.0, 0.5, 50, 10.0, 1390.377,180.0, 0, 1000000)
#print Aabso, error_asym, ini_xcntr, ini_ycntr, nn, flag_out, abs_zsum, sh_sum, ext_rad
