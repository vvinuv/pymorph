...
sex_cata = 'j8f645_sex.cat' #The sextractor catalogue which has the format given in the file
clus_cata = 'cl1216-1201.cat' #catalogue of galaxies from online catalogu service(name ra1 ra2 ra2 dec1 dec2 dec3)
out_cata = 'cl1216-1201_out.cat' #catalogue of galaxies in the field
psflist = ('psf_1216435-1203120.fits', 'psf_1216392-1202402.fits', 'psf_1216382-1200443.fits', 'psf_1216433-1202030.fits', 'psf_1216446-1203464.fits', 'psf_1216384-1201179.fits') #List of psf containg their position information in the header (RA_TARG, DEC_TARG). Make psf with the names as here and use psf_header_update.py. It will update the header information.
