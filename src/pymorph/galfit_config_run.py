...
class GalfitConfigRunFunc:
    ...
    def write_config(self, target, neighbours):
        ...
        self.galfit_conf = f'G_{self.fstring}.in' #GALFIT configuration file
        ...
        if 0:#os.path.exists(self.galfit_conf):
    ...
    def GalfitRun(self):    
        ...
        try:
            subprocess.run([self.GALFIT_PATH, self.galfit_conf], check=True)
