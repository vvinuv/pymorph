...
class GalfitConfigFunc:
    ...
    def _write_bulge(self, target, fcon):
        ...
        if self.detail == True:
            fcon.writelines([' 3) {:.2f} 1 # {}'.format(self.detailed[0], 
                                                        comment)])
        else:
        ...
        comment = 'R_e [Pixels]\n'
        if self.detail == True:
            fcon.writelines([' 4) {:.2f} 1 # {}'.format(self.detailed[1],
                                                        comment)])
        else:
    ...
    def _write_disk(self, target, fcon):
        ...
        comment = 'total magnitude\n'
        if self.detail == True:
            fcon.writelines([' 3) {:.2f} 1 # {}'.format(self.detailed[3], 
                                                        comment)])
        else:
            fcon.writelines([' 3) {:.2f} 1 # {}'.format(target.mag, comment)])
        ...
        comment = 'R_e [Pixels]\n'
        if self.detail == True:
            fcon.writelines([' 4) {:.2f} 1 # {}'.format(self.detailed[4],
                                                        comment)])
        else:
            fcon.writelines([' 4) {:.2f} 1 # {}'.format(target.radius, comment)])
    ...
    def _write_bar(self, target, fcon):
        ...
        comment = 'total magnitude\n'
        if self.detail == True:
            fcon.writelines([' 3) {:.2f} 1 # {}'.format(self.detailed[5], 
                                                        comment)])
        else:
            fcon.writelines([' 3) {:.2f} 1 # {}'.format(target.mag, comment)])
        ...
        comment = 'R_e [Pixels]\n'
        if self.detail == True:
            fcon.writelines([' 4) {:.2f} 1 # {}'.format(self.detailed[6], 
                                                        comment)])
        else:
            fcon.writelines([' 4) {:.2f} 1 # {}'.format(target.radius, comment)])
        ...
        if self.detail == True:
            fcon.writelines([' 5) {} 1 # {}'.format(self.detailed[7], comment)])
        else:
            fcon.writelines([' 5) 1.5 1 # {}'.format(comment)])
    ...
    def write_config(self):
        ...
        self.galfit_conf = 'G_{}.in'.format(self.fstring) #GALFIT configuration file
        ...
        if os.path.exists(self.galfit_file):
            ...
            # Here self.sex_cata is the neighbors
            for line_neigh in open(self.sex_cata, 'r'):
                #print(line_neigh) 
