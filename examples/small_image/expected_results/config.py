...
datadir = '/data2/home/ameert/pymorph/examples/small_image/data/'
...
outdir = '/data2/home/ameert/pymorph/examples/small_image/results/'
...
psflist = ['psf_1640239+4643504.fits']
...
#repeat = True				# set to true when fine tuning
...
cas = True
findandfit = 0
maglim = [20, 14] #if findandfit= 1, then maglim = [faint_mag, bright_mag]
stargal = 0.8 #Star-galaxy classification 
crashhandler = 0

###---Galfit Controls---###
components = ['bulge']        #The components to be fitted to the object
...
#devauc = True # set to False to fit sersic bulge, set to true to fit devacouler's bulge (n = 4)
